...
import { addSalesReturn, getProducts } from '@/lib/store';
...
import { RotateCcw, Plus, Trash2, Save, Printer } from 'lucide-react';
...
export default function SalesReturnSection() {
  ...
  const handleSave = () => {
    ...
    toast({ title: 'تم', description: 'تم حفظ مرتجع المبيعات بنجاح' });
    setCustomerName('');
    setItems([]);
  };
