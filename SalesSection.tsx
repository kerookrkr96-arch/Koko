...
import { ShoppingCart, Plus, Trash2, Save, Printer } from 'lucide-react';
...
export default function SalesSection() {
  ...
  const handleSave = () => {
    ...
    toast({ title: 'تم', description: 'تم حفظ البيعية بنجاح' });
    resetForm();
  };
  ...
  const handlePrint = () => {
    ...
    const printContent = `
      ...
      <head>
        <meta charset="UTF-8">
        <title>إيصال مبيعات - مؤسسة كيرو للأدوات الصحية</title>
        <style>
      ...
      <body>
        ...
        <div class="total">
          <p>المجموع: ${subtotal.toFixed(2)} ج.م</p>
          <p>الخصم: ${discountAmount.toFixed(2)} ج.م</p>
          <p>الإجمالي النهائي: ${finalTotal.toFixed(2)} ج.م</p>
        </div>
        <div class="footer">
